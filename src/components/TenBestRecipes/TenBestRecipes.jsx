    ...
    <h1 className='text-center fw-bold my-4'>These are the Top 10 Italian Recipes you Can also explore.</h1>
        <div>
            ...
            <Card className='bg-light shadow border-0 text-center'>
              ...
              <Card.Body>
                <Card.Title className='fw-bolder'>Caprese Salad with Pesto Sauce</Card.Title>
            ...
            <Card className='bg-light shadow border-0 text-center'>
              ...
              <Card.Body>
                <Card.Title className='fw-bolder'>Pasta Con Pomodoro E Basilico</Card.Title>
                <Card.Text className='fw-semibold'>
            ...
            <Card className='bg-light shadow border-0 text-center'>
              ...
              <Card.Body>
                <Card.Title className='fw-bolder'>Tiramisu - The 'pick-me-up' cake</Card.Title>
                <Card.Text className='fw-semibold'>
