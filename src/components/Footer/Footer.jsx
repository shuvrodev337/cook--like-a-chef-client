    ...
    return (
        <footer className='footer mt-auto py-3 bg-dark text-white text-center'>
            <div className='container'>
                <Link to={"/"}><button type="button" className="btn btn-secondary btn-sm mx-2">About Us</button></Link>
                <Link to={"/blog"}><button type="button" className="btn btn-secondary btn-sm">Our Blog</button></Link>
